...
read the above code carefully..
  in above bar chart code offline count is disply but in
  below map code offline count is  not disply,
  can tell me what is the issue, and how to slve it, read boht code carefully, and give me correct code
for map 
(function () {
  // ---------- Globals ----------
  let realMap = null;
