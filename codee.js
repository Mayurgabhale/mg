i want to add each controller again door, ok 
when i clikc on this controller i want to disply that connect door,
  
controller alread disply i just want to disply the door,
  when i cliick on this controller card that time i want open pop-up door list that is coneect to the controllre, 
  so how to do this 
  ok read the below all code carefullym also script.js file is our main file and give me the updte code, 
  wiht my above requrement ok,, 
  do carefully, 
