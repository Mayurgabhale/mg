next and priv are not work.. 
  read the belwo all code carefully, and how to do this 
(function () {
    ...
    function EmeaPinApp() {
      ...
      // --- MISSING HELPERS RESTORED (fixes the ReferenceError) ---
      ...
      const DetailsPanel = () => {
        ...
        // const end = Math.min(detailsTotal, start + detailsLimit);
         ...
         // ------------------------------------------------
    // 🔥 REQUIRED PAGINATION FIX (your missing part)
    // ------------------------------------------------
    const start = detailsOffset;
    const end = detailsOffset + detailsLimit;
    const paginatedRows = filteredAll.slice(start, end);
        return (
        ...
        <div className="container" >
          ...
          <div className="topbar" role="banner">
            <div style={{ display:'flex', alignItems:'center', gap:12, justifyContent:'center' }}>
              ...
              <div style={{ }}>
                <h1 style={{ margin: 0, fontSize: 18,color: '#000' }}>EMEA PIN — Live Dashboard</h1>
                <div style={{ fontSize: 15,  margin: 0,color: '#ffd400',}}>Live PIN rejections</div>
              </div>
            </div>

            <div className="header-actions">
              <div style={{ display:'flex', gap:8, alignItems:'center' }} className="top-controls">
                <label className="small" style={{ color:'#000' ,fontSize: 15,}}>Year</label>
                ...
                <label className="small" style={{ color:'#000' ,fontSize: 15, }}>Month</label>
                ...
                <label className="small" style={{ color:'#000' ,fontSize: 15, }}>Location</label>
          ...
          { view === 'dashboard' ? (
            <div style={{ display:'flex', gap:12 }}>
              <div style={{ flex:1 }}>
                ...
                <div style={{ background:'#fff', padding:2, borderRadius:10, boxShadow:'0 6px 18px rgba(2,6,23,0.04)' }}>
                 
                  <div className="chart-wrap chart-small" style={{ marginBottom:12 }}>
                     <h4 style={{ margin:0, textAlign:'center', }}>Location wise</h4>
                    <canvas ref={locChartRef}></canvas>
                  </div>

                  <div style={{ marginTop:10,marginBottom:12 , fontSize:13, color:'#64748b',display:"none" }}>
                    Last fetch: {lastFetch ? new Date(lastFetch).toLocaleString() : 'never'} {loading ? ' • loading…' : ''}
                  </div>
                </div>

                {/* Month panel */}
                <div style={{ margin:0, background:'#fff', padding:2, borderRadius:10, boxShadow:'0 6px 18px rgba(2,6,23,0.04)' }}>
                  ...
                  <div className="chart-wrap month-chart-wrap" style={{ margin:0 }}>
                    
                    <h4 style={{ margin:0, textAlign:'center' }}>Month-wise analysis</h4>
              ...
              <aside style={{ width: 340 }}>
                ...
                <div className="card" style={{ padding:10,}}>
                  ...
                  <div>
                    <h5 style={{ margin:'0px 0', textAlign:'center' }}>
                ...
                <div className="card" style={{ padding:10, textAlign:'center' }}>
                  <h4 style={{ margin:0 }}>Top repeaters{selectedMonth === 0 ? " — All months" : ` - ${MONTH_NAMES[selectedMonth-1]}`}</h4>
