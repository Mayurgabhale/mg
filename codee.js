...
document.addEventListener("DOMContentLoaded", () => {
  initRealMap();
  // show empty markers if any (will be overwritten by updateMapData)
  placeCityMarkers();
...
in above code isonc is blink,
   but in below code icon is not blink,
   but i sue below code, so tell me in beloow code what i need to change ok
in below code read the above code, because below is my fully working code..
   ok 
 ============================================================ */
