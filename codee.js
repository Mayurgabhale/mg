...
how to fix this,, 
  i give me graph.js file in this file 
the offline device chart is showing the correct data ok, so read teh graph.js file and use same logic, and calling fucntin or more 
and in this boht alos i want ot dilsy correct count offline and online count ok
read this file carefully and correct it,  ok 
in Offline Device chart mexico camers getting 9 camere offline but in LOC count not show any one ok 
like that more issue in LOC count chart  ok 
first i give upoi fie graph.js file read this first then correct this ok ..
