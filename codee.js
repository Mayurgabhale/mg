When first time start backend or restarted then call all History APi once 
then Whenever user want to check historical data exclude today display data Quickly...
using Histirical data API.
Dont call History APi every time ..
