src\pages\History.jsx
  Line 2613:10:  'subDays' is defined but never used                                                                                                                                                no-unused-vars
  Line 2732:7:   'clearHistoryCache' is assigned a value but never used                                                                                                                             no-unused-vars
  Line 2884:4:   React Hook useEffect has missing dependencies: 'CACHE_TTL_MS', 'backendFilterKey', 'loadHistoryCache', and 'saveHistoryCache'. Either include them or remove the dependency array  react-hooks/exhaustive-deps
  Line 2968:22:  Unnecessary escape character: \/                                                                                                                                                   no-useless-escape
  Line 2968:24:  Unnecessary escape character: \-                                                                                                                                                   no-useless-escape
  Line 3193:6:   React Hook useMemo has a missing dependency: 'getCanonicalCompany'. Either include it or remove the dependency array                                                               react-hooks/exhaustive-deps
  Line 3242:6:   React Hook useMemo has a missing dependency: 'getCanonicalCompany'. Either include it or remove the dependency array                                                               react-hooks/exhaustive-deps
  Line 3817:9:   'companyColSpan' is assigned a value but never used                                                                                                                                no-unused-vars
