i want to create one more chart in this,
  is bar chart ok
city wise, ok
in this bar chart i want to disply bar chart in ic loc count char ok
1. in this i want ot show total count ciyt wise, 
  and alos ok in 
  tooltip like this 
Total Device: 
Risk Level:
...
Offline Controllers;
Offline CCURE: 
and risk like Cameras offline medium ok
and Cameras + Controllers.,CCURE,Archivers 
or onlye Archivers,Controllers or CCURE that time onye hight risk ok 
like that wiht color, and 
in tooltip offline count in red color
and 
in x axis, show only city name tht risk leve is midumn or hight ok 
