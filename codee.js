...
read above code and add in below code,, and i want same api end point in below dont chagen my privus code logic, just update above code login in this below ok 
carefully..
    in all api end point ok 
