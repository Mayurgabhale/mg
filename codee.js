i use world map but in  top part of map i dont want ot see. i means this part that wya i map is vision is vry big i want ot diplsy only my locatin Greenland
for exmaple this is our locaton so map top part is is not in this ok 

so how to adjust the map that way my is diplsy perfect and big. 
    for better visabilty ok.. so how to do this 
...
<select id="city-filter">
    ...
    <option value="Pune 2nd Floor">Pune 2nd Floor</option>
    <option value="Pune Podium">Pune Podium</option>
    <option value="Pune Tower B">Pune Tower B</option>
...
read belwo all code and carefully...
