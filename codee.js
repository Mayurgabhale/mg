now i want to do my this Loc count more adance ok,
  ...
  if Archivers is offline -- midium- minor 
   if Controllers and  CCURE -- high - significant 
like that i iwant to use and create my loc count wiht suihg risk assessmetn 
like this above image ok,, 
  ...
  cityChart = new Chart(chartCanvas.getContext("2d"), {
    ...
    options: {
      ...
      scales: {
        ...
        x: {
          ticks: {
            display: false   // ✅ hide city names only
          },
          grid: {
            display: true
          }
