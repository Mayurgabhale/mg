...
in this hole tooltip text is yellow, i dont want hole tooltip text color chagen,
  i want only if device offline count is presetn that time ony show the red text color
 `Offline Controller: ${ctrlOff}`, 1  red
  `Offline Server: ${srvOff}`, 3   red
  `Offline Archiver: ${archOff}` 0 not red 
let cityChart = null;
