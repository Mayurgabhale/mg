our location is only in APAC, EMEA,NAMER and LACA
so i want to disply on this. in map i want to zoom only this part ok 
so who to do this 
...
function initRealMap() {
  ...
  .setView([20, 10], 2.3); // Start view (adjust as you want)
