 const resp = await fetch(`${API_ORIGIN}/api/current-occupancy`); Remove this api, we not writ this api in backnd 
i measn this is not present in backend 
in backedn only this 
...
module.exports = router;
 ...
 const resp = await fetch(`${API_ORIGIN}/api/current-occupancy`); remove this 
