...
in this script, i want to remove all map, calling code,
for examkple, i map use use in this code, for map, to get data or count in map, fomr this code,
  ok 
we gett all map count from this code,
  i mesn i am calling some mpa function in this ok 
so whater ever code for map in this that all code i want to remvoe ok 
so remove all code for map, 
  and give me correct script.js file
note dont chane nay other codeor dont tuch ok 
juste remve the map  code in this ok 
