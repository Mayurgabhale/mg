...
[eslint] 
src\App.js
  Line 1104:1:  Import in body of module; reorder to top  import/first
  Line 1105:1:  Import in body of module; reorder to top  import/first
  Line 1106:1:  Import in body of module; reorder to top  import/first
  Line 1107:1:  Import in body of module; reorder to top  import/first
      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="px-3">
        ...
        <Navbar.Collapse id="main-navbar">
          <Nav className="ms-auto align-items-center gap-2">
            ...
            <Nav.Link as={Link} to="/ert" className="nav-item-infographic"> <MdAddAlert /> ERT Overview</Nav.Link>
            <Nav.Link as={Link} to="/companysummary" className="nav-item-infographic"><FaBuildingCircleCheck />Company Summary</Nav.Link>
