when i use this that map colling or in this that time we got wrong count,
  but i use same in bar chart but bar not getting wrong, i want to chage in this code,map code,
  i want use sma logic, for bar chart ok that time we getting correct count,
  ok rihg in map we geting weorng count, ok but bar getting correct count 
what we need to do tchage in tghis code onoy mpa calling function ok 
