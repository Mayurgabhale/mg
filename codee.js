...
Download
Internal Server Error
INFO:     127.0.0.1:54722 - "GET /daily_sheet/records HTTP/1.1" 200 OK
INFO:     127.0.0.1:49918 - "POST /daily_sheet/upload HTTP/1.1" 500 Internal Server Error
...
INFO:     127.0.0.1:53318 - "GET /daily_sheet/records HTTP/1.1" 200 OK
INFO:     127.0.0.1:53318 - "GET /regions HTTP/1.1" 404 Not Found

@@@ read above error or issue an dhow to slov it, 
    http://127.0.0.1:8000/daily_sheet/records
data uploded in database but not show success message..
    and gettng above error:: 
and also this 
500
Undocumented
Error: Internal Server Error
...
but data is uploaded 
read beloow alll code and how to fix above erroor 
{
  "count": 100,
  "items": [
    {
