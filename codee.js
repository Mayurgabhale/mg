...
this is the live details page,
  in this issue is the when i select regisn in selet box that time note select emegiatly 
for examle i selct regisn than i do reload the page that time diplsy selecte reges dat,
  if i want to selct onthe region then select then reload the page, ok 
it is more time consuming ok i want fast responve ok 
...
/////////// this is header code is here  ⬇️⬇️
