...
TypeError: data.filter is not a function
    at EmployeeTravelDashboard (http://localhost:3000/static/js/bundle.js:195233:29)
    at react-stack-bottom-frame (http://localhost:3000/static/js/bundle.js:36183:18)
    at renderWithHooks (http://localhost:3000/static/js/bundle.js:26393:20)
    at updateFunctionComponent (http://localhost:3000/static/js/bundle.js:28086:17)
    at beginWork (http://localhost:3000/static/js/bundle.js:28672:16)
    at runWithFiberInDEV (http://localhost:3000/static/js/bundle.js:24165:68)
    at performUnitOfWork (http://localhost:3000/static/js/bundle.js:30745:93)
    at workLoopSync (http://localhost:3000/static/js/bundle.js:30638:38)
    at renderRootSync (http://localhost:3000/static/js/bundle.js:30622:7)
    at performWorkOnRoot (http://localhost:3000/static/js/bundle.js:30386:42)
