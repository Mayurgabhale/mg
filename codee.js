...
not one i want i want belw this boht in one   {activeTab === "uploadMonthly" && ( and this    {/* Compact Upload Section */}
                        <div style={styles.compactUploadRow}>
                            <div style={styles.compactFileUpload}>  
                            
    Quick File Upload afte click then disply this both ok    
