...
TypeError: undefined is not iterable (cannot read property Symbol(Symbol.iterator))
    at EmployeeTravelDashboard (http://localhost:3000/static/js/bundle.js:304944:61)
    at react-stack-bottom-frame (http://localhost:3000/static/js/bundle.js:37079:18)
    at renderWithHooks (http://localhost:3000/static/js/bundle.js:27289:20)
    at updateFunctionComponent (http://localhost:3000/static/js/bundle.js:28982:17)
    at beginWork (http://localhost:3000/static/js/bundle.js:29568:16)
    at runWithFiberInDEV (http://localhost:3000/static/js/bundle.js:25061:68)
    at performUnitOfWork (http://localhost:3000/static/js/bundle.js:31641:93)
    at workLoopSync (http://localhost:3000/static/js/bundle.js:31534:38)
    at renderRootSync (http://localhost:3000/static/js/bundle.js:31518:7)
    at performWorkOnRoot (http://localhost:3000/static/js/bundle.js:31282:42)
const [showUploadFileSection,setShowUploadFileSectino] = useEffect(false);         {/* Compact File Upload Section */}
                   how ot slove this
  ...
  <div>
    ...
    {!showUploadFileSection && (
      <div style={styles.showUploadButtonContainer}>
        <button 
          onClick={() => setShowUploadFileSectino(true)}
      ...
      <div style={styles.uploadMonthlyContainer}>
        ...
        <div style={styles.leftPanel}>
          <div style={styles.headerSection}>
            ...
            <button 
              onClick={() => setShowUploadFileSectino(false)}
