...
in Type if select Camera that time onlye 
 <label>Details*</label>
      <input id="device-details" type="text" placeholder="e.g FLIR, Verkada">

      <label>Hyperlink</label>
      <input id="device-hyperlink" type="url" placeholder="e.g https://wu.command.verkada.com/cameras/06f21d3e-3075-4793-859a-2bf90736f839">

      <label>Remark</label>
      <input id="device-remark" type="text" placeholder="e.g Not accessible">

 Details, Hyperlink,Remark are displsy other wise hide it ok 
      how to do this 
