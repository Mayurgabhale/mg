index.html:1 An invalid form control with name='' is not focusable. <input id=​"Host-Name" type=​"text" placeholder=​"e.g " required>​
index.html:1 An invalid form control with name='' is not focusable. <input id=​"PC-Name" type=​"text" placeholder=​"e.g " required>​
index.html:1 An invalid form control with name='' is not focusable. <input id=​"db-hostname" type=​"text" placeholder=​"e.g SRVWUDEN0890v" required>​
index.html:1 An invalid form control with name='' is not focusable. <input id=​"db-application" type=​"text" placeholder=​"e.g CCURE SAS App" required>​
index.html:1 An invalid form control with name='' is not focusable. <input id=​"db-windows-server" type=​"text" placeholder=​"e.g Windows Server 2019 Standard" required>​
  <!-- Device Modal -->
    ...
    <div class="modal-content">
      ...
      <form id="device-form">
        ...
        <span id="name-field">
          ...
          <input id="device-name" type="text" placeholder="e.g Device Name" required>
        </span>


        <label>IP Address<span class="required">*</span></label>
        <input id="device-ip" type="text" placeholder="e.g 10.100.111.11" required>

        <div id="pc-fields" style="display:none;">
          <label>Host Name<span class="required">*</span></label>
          <input id="Host-Name" type="text" placeholder="e.g " required>
          <label>PC Name<span class="required">*</span></label>
          <input id="PC-Name" type="text" placeholder="e.g " required>
        </div>

        <div id="db-fields" style="display:none;">
          <label>Host Name<span class="required">*</span></label>
          <input id="db-hostname" type="text" placeholder="e.g SRVWUDEN0890v" required>

          <label>Application<span class="required">*</span></label>
          <input id="db-application" type="text" placeholder="e.g CCURE SAS App" required>

          <label>Windows Server<span class="required">*</span></label>
          <input id="db-windows-server" type="text" placeholder="e.g Windows Server 2019 Standard" required>
        </div>

        <label>Location<span class="required">*</span></label>
        <input id="device-location" type="text" placeholder="e.g APAC, EMEA, LACA, NAMER" required>

        <label>City<span class="required">*</span></label>
        <input id="device-city" type="text" placeholder="e.g Pune, Denver" required>


        <!-- CAMERA FIELDS ONLY -->
        <div id="camera-fields">
          <label>Details<span class="required">*</span></label>
          <input id="device-details" type="text" placeholder="e.g FLIR, Verkada" required>
        ...
        <div id="added-by-box" style="display:none;">
          ...
          <input id="device-added-by" type="text" placeholder="Your Name" required>
        </div>

        <!-- Updated By -->
        <div id="updated-by-box" style="display:none;">
          <label>Updated B<span class="required">*</span></label required>
