...
this is wrong i want to show all  DB Details
...
function detectTypeFromDeviceObj(obj) {
    ...
    if (obj.databasename || obj.DBname || obj.DBDetails) return "dbdetails";
  ...
  <div class="modal-content">
    ...
    <form id="device-form">
      ...
      <select id="device-type" required onchange="updateFormFields()">
        ...
        <option value="dbdetails">DB Details</option>  <<< when i opne  dbdtails ok 
      </select>
