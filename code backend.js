 ...
 this is wrong ok  in this we need not a person name 
in this i want if new device add Add By or Edit, first show 
ok if new device is add then add by or if exsitng devide is updare then firs show in this name then afte edit and pudate edite name ok 
    i want do this read beloola boht bakcned and frent ok and do, how to do this 
<!-- Device Modal -->
