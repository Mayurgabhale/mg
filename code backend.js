now in this small issue 
the issue is
when i add Controller that Controller again if has door and reader then we add this but
in data base controller_doors table contreole and again door is not store 
i want to store also this  ok 
