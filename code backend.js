i want to make this form one professal form, wiht all fomr futures
and wiht when number wer type only numbe not text ok,
the form input getting error when i enter the data in input box,
  use libar or advance algorithm for desin this from ok,
writ now waht happen we submit button if any error that time now error message but i want when i fill data that time i want ot show error ok 
futh advance, all requr full fill, ok 
  creare like that this form and alos deisn thie more more professal deisn not i say professal design ok
can you do this 
