read the above upload code and why data is not loading in the page,
  and read the below all code boht files and give me update both file code ok
above upload code is working ok, but this is not ok..
