    ...
    async function loadControllers() {
      try {
        ...
        const mockControllers = [
          {
            controllername: "Main Building Controller",
            IP_address: "192.168.1.100",
            controllerStatus: "Online",
            Doors: [
              { Door: "Main Entrance", Reader: "RFID-001", status: "Online" },
              { Door: "East Wing", Reader: "RFID-002", status: "Online" },
              { Door: "West Wing", Reader: "RFID-003", status: "Offline" },
              { Door: "Server Room", Reader: "RFID-004", status: "Online" }
            ]
          },
          {
            ...
            controllerStatus: "Online",
            Doors: [
              { Door: "Garage Entrance", Reader: "RFID-005", status: "Online" },
              { Door: "Garage Exit", Reader: "RFID-006", status: "Online" },
              { Door: "Elevator Lobby", Reader: "RFID-007", status: "Online" }
            ]
          },
          {
            controllername: "North Wing Controller",
            IP_addre